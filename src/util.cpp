...
int nAnonymizeq8ecoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\q8ecoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\q8ecoin
    // Mac: ~/Library/Application Support/q8ecoin
    // Unix: ~/.q8ecoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "q8ecoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "q8ecoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "q8ecoind.pid"));
