...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("24.202.193.229", "24.202.193.229"));
        vSeeds.push_back(CDNSSeedData("5.189.129.172", "5.189.129.172"));
        vSeeds.push_back(CDNSSeedData("87.27.50.195", "87.27.50.195"));
