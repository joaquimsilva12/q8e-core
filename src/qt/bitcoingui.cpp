...
{
    resize(900, 520);
    setWindowTitle(tr("Q8E") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("q8ecoin");
    //setStyleSheet("#q8e { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
   // setStyleSheet("#q8e { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #fcfcfc, stop: 1 #ffffff);  }");
    setStyleSheet("#q8ecoin { background-color: rgb(192,192,192); background-image: url(:/images/bkg);}");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Senhistory.pngd coins to a Q8E address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/transactionlist"), tr("&TRANSACTIONS"), this);
    ...
    investAction = new QAction(QIcon(":/icons/invest"), tr("&Q8E WEBSITE"), this);
    investAction->setToolTip(tr("Q8E Website"));
    investAction->setCheckable(true);
    investAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(investAction);
    
    discordAction = new QAction(QIcon(":/icons/discord"), tr("&Q8E DISCORD"), this);
    discordAction->setToolTip(tr("Q8E Discord"));
    ...
    connect(investAction, SIGNAL(triggered()), this, SLOT(gotoinvestPage()));
    	connect(discordAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(discordAction, SIGNAL(triggered()), this, SLOT(gotodiscordPage()));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&Q8E Website"), this);
	pioAction->setToolTip(tr("Visit the Official Q8E website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Q8E discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&Q8E Slack"), this);
	chainAction->setToolTip(tr("Join Q8E Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Q8E Explorer"), this);
	explorerAction->setToolTip(tr("Q8E Explorer"));
    aboutAction = new QAction(tr("&About Q8E"), this);
    aboutAction->setToolTip(tr("Show information about Q8E"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Q8E"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet(fUseBlackTheme ?"#tabs { color: #000000; background-color: #0F0F0F; border: none; padding-top: 0px; padding-bottom: 0px; }" :"QToolButton { color: #ffffff; font-size: 13px; font-weight: 500; font-family: 'Roboto'; padding: 5px; padding-left: 8px; border: none; }" 
                           ...
                           "QToolButton:pressed { background-color: #696969; border: none; padding-top: 5px; padding-bottom: 5px; }"
    ...
    toolbar->addAction(discordAction);
...
void BitcoinGUI::setToolBarDefaultIcons () {
    ...
    historyAction->setIcon(QIcon(":/icons/transactionlist"));
    addressBookAction->setIcon(QIcon(":/icons/address-book"));
    masternodeManagerAction->setIcon(QIcon(":/icons/masternodes"));
    messageAction->setIcon(QIcon(":/icons/edit"));
    investAction->setIcon(QIcon(":/icons/invest"));
    discordAction->setIcon(QIcon(":/icons/discord"));
    blockAction->setIcon(QIcon(":/icons/block"));
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Q8E client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Q8E client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Q8E network", "", count));
}
...
void BitcoinGUI::gotoMasternodeManagerPage()
{
    ...
    masternodeManagerAction->setIcon(QIcon(":/icons/masternodesoverlay"));
...
void BitcoinGUI::gotoOverviewPage()
{
    ...
    setToolBarDefaultIcons();
    overviewAction->setIcon(QIcon(":/icons/overviewoverlay"));
    exportAction->setEnabled(false);
    disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}
...
{        
    setToolBarDefaultIcons();
    historyAction->setIcon(QIcon(":/icons/transactionlistoverlay"));
...
{
    setToolBarDefaultIcons();
    receiveCoinsAction->setIcon(QIcon(":/icons/receiving_addressesoverlay"));
...
{
    setToolBarDefaultIcons();
    sendCoinsAction->setIcon(QIcon(":/icons/sendoverlay"));
...
void BitcoinGUI::gotodiscordPage()
{
  setToolBarDefaultIcons();
  discordAction->setIcon(QIcon(":/icons/discordoverlay"));  
    
  discordAction->setChecked(true);
  QDesktopServices::openUrl(QUrl("https://discord.gg/6kWGRXV"));
  exportAction->setEnabled(false);
  disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}
...
{
    setToolBarDefaultIcons();
    messageAction->setIcon(QIcon(":/icons/editoverlay")); 
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Q8E address or malformed URI parameters."));
    }
