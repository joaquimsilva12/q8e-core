...
private slots:
    ...
    QString BuyQ8E(QString OrderType, double Quantity, double Rate);
    QString SellQ8E(QString OrderType, double Quantity, double Rate);
